 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("JitaeKim");
		  toPrint += p1.toString("jkim3181");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Austin Adams");
		  toPrint += p2.toString("aadams80");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Hyungsuk Do");
		  toPrint += p3.toString("hdo31");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Xin Zhang");
                  toPrint += p4.toString("xzhang401");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Claude Peon");
                  toPrint += p5.toString("ppeon3");
